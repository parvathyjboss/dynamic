...
1. [Setup - The basics of getting started with dynamic](#setup)
    * [What dynamic affects](#what-dynamic-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with dynamic](#beginning-with-dynamic)
